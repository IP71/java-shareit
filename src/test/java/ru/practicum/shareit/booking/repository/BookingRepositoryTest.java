...
public class BookingRepositoryTest {
    ...
    public void findFirst1ByItemIdAndStartIsBeforeAndStatusIsNotOrderByEndDescTest() {
        Optional<Booking> booking = bookingRepository.findFirst1ByItemIdAndStartIsBeforeAndStatusIsNotOrderByEndDesc(3L, date, Status.APPROVED);
        assertTrue(booking.isEmpty());
    }

    @Test
    public void findFirst1ByItemIdAndStartIsAfterAndStatusIsNotOrderByStartAscTest() {
        Optional<Booking> booking = bookingRepository.findFirst1ByItemIdAndStartIsAfterAndStatusIsNotOrderByStartAsc(3L, date, Status.APPROVED);
